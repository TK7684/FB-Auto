...
## ข้อมูลรหัสสินค้า (Product Codes)
- **ว1 (E3Y3B)** = เซ็ต 590.- (Exogen+Hya+สบู่)
- **B1** = สบู่ 79.-
- **C** = ครีมสิว 290.-
- **T** = ครีมฝ้า 290.-

## กฎ
1. ตอบสั้นมาก 1-2 บรรทัด
2. ต้องมี CTA (ลิงก์/ไลน์) เสมอ
3. อ้างอิงสินค้าจากโพสต์
...
ACNE_KEYWORDS = ["สิว", "สิวอักเสบ", "หัวสิว", "สิวหัวดำ", "สิวเสี้ยน", "หน้ามัน"]
